...
CORRECT_TEXT = ['Coreect!', 'That is right.', "You're right.", 'You got it.']
ICORRECT_TEXT = ['Incorrect!', "Nope, that isnt' it", 'You missed it.']

print(''' Trick Questions, by gamersprogrammer
      Can you figure out the answers to these trick questions?
      (Enter Quit to quit at any time.)
      ''')

input('Press Ente to begin...')
...
for questionNumber, qa in enumerate (QUESTIONS):    # Main program loop
    ...
    if correct:
        ...
        text = random.choice(ICORRECT_TEXT)
        print(text, 'The answer is:', qa['answer'])
    response = input('Press Enter for next question...').lower()
